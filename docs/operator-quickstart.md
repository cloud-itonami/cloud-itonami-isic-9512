# Operator Quickstart — Repair of communication equipment

Shortest path from clone to a verified local dry-run for **ISIC 9512** (`cloud-itonami-isic-9512`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9512.git
cd cloud-itonami-isic-9512
```
...
- Likely source path: `commrepair.governor.cljc`
